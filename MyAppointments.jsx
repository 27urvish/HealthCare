...
//   // Show Google Pay QR Code
//   const handleGooglePayQR = (appointment) => {
//     setShowQrCode(appointment);
//   };
...
//         setShowQrCode(null); // Hide the QR code modal
...
//                 <button
//                   onClick={() => handleGooglePayQR(item)}
...
//                     `upi://pay?pa=kapadiyaurvish2727@okicici&pn=Urvish%20Kapadiya&am=${showQrCode.docData.fee}&cu=INR&tn=Doctor%20Fee`
//                   )}`}
...
//               </p>
//               <p className="font-medium">Amount: ₹{showQrCode.docData.fee}</p>
//             </div>
...
//               </button>
//               <button
//                 onClick={() => completePayment(showQrCode._id)}
