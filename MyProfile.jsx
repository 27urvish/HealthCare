        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            {isEdit
                ? <label htmlFor='image' >
                    ...
                    <img className='w-36 rounded-circle opacity-75 ' src={image ? URL.createObjectURL(image) : userData.image} alt="" />
                    <img className='w-10 absolute bottom-12 right-12' src={image ? '' : assets.upload_icon} alt="" />
                    </div>
                    <input onChange={(e) => setImage(e.target.files[0])} type="file" id="image" hidden />
                </label>
                : <img style={{borderRadius:"50%",width:"100px",height:"100px"}} className='w-36 rounded-full object-cover ' src={userData.image} alt="" />
            }
